...
namespace Games.SkillModle
{
    ...
    public class SkillCore
    {
        ...
        public void CheckSkillShouldFinish()            //技能完成前检查
        {
        ...
        bool CanShowSkillProgress(int skillId)              //是否可以显示技能进度
        {
        ...
        void onloadbullet(GameObject bulleteffect, object param)    //加载子弹
        {
            //bulletdata curdata = param as bulletdata;
            //if (bulleteffect != null && curdata != null)
            //{
            //    //bullet _bullet = bulleteffect.getcomponent<bullet>();                 //子弹
            //    //if (_bullet != null)
            //    //{
        ...
        void PlayAnimation(int AnimationId)                         //播放动画
        {
            ...
            //    //m_SkillSender.AnimLogic.Play(AnimationId);            //动画逻辑脚本的播放方法
            //}
        }

        public void BreakCurSkill()                         //打断当前技能
        {
            //打断当前技能动作
